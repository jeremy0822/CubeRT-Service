...
public class IPSeeker {
    ...
    private static final Logger log = Logger.getLogger(IPSeeker.class);
    // 一些固定常量，比如记录长度等等
    ...
    public IPSeeker(String source)  {
        ...
        b3 = new byte[3];
        try {
            ipFile = new RandomAccessFile(source, "r");
